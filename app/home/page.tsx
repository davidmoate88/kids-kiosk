...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-8 gap-10 max-w-4xl mx-auto">
      <div className="text-center">
        <p className="text-3xl font-bold text-foreground/60">Hiya {profile?.name ?? "there"}!</p>
        <h1 className="text-5xl font-extrabold">What shall we do?</h1>
      </div>
